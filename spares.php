                    ...
                    <div class="container">
                        ...
                        <li>
                            ...
                            <div class="info">
                                ...
                                <p class="categories">
                                    Component categories: <strong>Braking Systems &gt; Hydraulic System</strong>
                                </p>
                        ...
                        <li>
                            ...
                            <ul class="pricing">
                                ...
                                <li class="print-hide">
                                    ...
                                    <input type="hidden" class="sid" value="247">
                                    <input type="hidden" class="price" value="1500.00">
                                </li>
                                <li class="print-hide"><a href="/basket" title="Proceed to the checkout to send your order...." class="btn_addBasket">Add to basket</a></li>
                            </ul>
                            <div class="info">
                                ...
                                <p class="categories">
                                    Component categories: <strong>Braking Systems &gt; Air/Oil System &gt; Complete Air/Oil System</strong>
                                </p>
                        ...
                        <li>
                            ...
                            <ul class="pricing">
                                ...
                                <li class="print-hide">
                                    ...
                                    <input type="hidden" class="sid" value="248">
                                    <input type="hidden" class="price" value="1250.00">
                                </li>
                                <li class="print-hide"><a href="/basket" title="Proceed to the checkout to send your order...." class="btn_addBasket">Add to basket</a></li>
                            </ul>
                            <div class="info">
                        ...
                        <li>
                            ...
                            <ul class="pricing">
                                ...
                                <li class="print-hide">
                                    ...
                                    <input type="hidden" class="sid" value="249">
                                    <input type="hidden" class="price" value="150.00">
                                </li>
                                <li class="print-hide"><a href="/basket" title="Proceed to the checkout to send your order...." class="btn_addBasket">Add to basket</a></li>
                            </ul>
                            <div class="info">
                                ...
                                <p class="categories">
                                    Component categories: <strong>Braking Systems &gt; Air/Oil System &gt; Air/Oil System Parts</strong>
                                </p>
                        ...
                        <li>
                            ...
                            <ul class="pricing">
                                ...
                                <li class="print-hide">
                                    ...
                                    <input type="hidden" class="sid" value="250">
                                    <input type="hidden" class="price" value="19.50">
                                </li>
                                <li class="print-hide"><a href="/basket" title="Proceed to the checkout to send your order...." class="btn_addBasket">Add to basket</a></li>
                            </ul>
                            <div class="info">
                        ...
                        <li>
                            ...
                            <ul class="pricing">
                                <li>Unit weight: <strong>2.00kg</strong></li>
                                <li>Cost per item: <strong>£750.00</strong></li>
                                <li class="print-hide">
                                    Quantity required:
                                    <select class="quantity">
                                        <option value="1"> 1 </option>
                                    ...
                                    <input type="hidden" class="sid" value="1534">
                                    <input type="hidden" class="price" value="750.00">
                                </li>
                                <li class="print-hide"><a href="/basket" title="Proceed to the checkout to send your order...." class="btn_addBasket">Add to basket</a></li>
                            </ul>
                            <div class="info">
                        ...
                        <li>
                            ...
                            <ul class="pricing">
                                ...
                                <li class="print-hide">
                                    ...
                                    <input type="hidden" class="sid" value="1535">
                                    <input type="hidden" class="price" value="285.00">
                                </li>
                                <li class="print-hide"><a href="/basket" title="Proceed to the checkout to send your order...." class="btn_addBasket">Add to basket</a></li>
                            </ul>
                            <div class="info">
                                ...
                                <p class="categories">
                                    Component categories: <strong>Braking Systems &gt; Air/Oil System Parts</strong>
                                </p>
                        ...
                        <li>
                            ...
                            <ul class="pricing">
                                <li>Unit weight: <strong>2.00kg</strong></li>
                                <li>Cost per item: <strong>£10.25</strong></li>
                                <li class="print-hide">
                                    Quantity required:
                                    <select class="quantity">
                                        <option value="1"> 1 </option>
                                    ...
                                    <input type="hidden" class="sid" value="1536">
                                    <input type="hidden" class="price" value="10.25">
                                </li>
                                <li class="print-hide"><a href="/basket" title="Proceed to the checkout to send your order...." class="btn_addBasket">Add to basket</a></li>
                            </ul>
                            <div class="info">
                                ...
                                <p class="notes">Notes: Fits to Airbrake Kit.</p>
                        ...
                        <li>
                            ...
                            <ul class="pricing">
                                <li>Unit weight: <strong>2.00kg</strong></li>
                                <li>Cost per item: <strong>£90.00</strong></li>
                                <li class="print-hide">
                                    Quantity required:
                                    <select class="quantity">
                                        <option value="1"> 1 </option>
                                    ...
                                    <input type="hidden" class="sid" value="1537">
                        ...
                        <li>
                            ...
                            <ul class="pricing">
                                ...
                                <li>Cost per item: <strong>£575.00</strong></li>
                                <li class="print-hide">
                                    Quantity required:
                                    <select class="quantity">
                                        <option value="1"> 1 </option>
                                    ...
                                    <input type="hidden" class="sid" value="1538">
                                    <input type="hidden" class="price" value="575.00">
                                </li>
                                <li class="print-hide"><a href="/basket" title="Proceed to the checkout to send your order...." class="btn_addBasket">Add to basket</a></li>
                            </ul>
                            <div class="info">
