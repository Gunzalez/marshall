                            ...
                            <li class="first-child selected">
                                ...
                                <form id="search-filter" method="post">
                                    <fieldset id="fields">
                                        ...
                                        <p>
                                            <input type="submit" id="find" value="Search" class="big-link blue-link find">
                                            <input type="button" id="reset" value="Reset" class="big-link blue-link reset" onclick="location.href='spares.php'">
                                        </p>
                                    </fieldset>
                                </form>
                            </li>
                            ...
                            <form>
                                <ol>
                                    <li>
                                        ...
                                        <div class="container">
                                            <a href="http://www.marshall-trailers.co.uk/uploads/spares/large/050-01-0664.jpg" title="74&quot; (1880) 70mm 6 stud 300x60 brake axle (ADR) Post-2000" class="fancybox spare-thumbnail">
                                                    ...
                                                    <div class="related">
                                                        ...
                                                        <ul>
                                                            <li data-sid="1155" data-price="40.00" class="cf">
                                                                ...
                                                                <div class="add"><a href="/basket" title="Add this item to the basket...." class="btn_addBasketRelated">Add</a></div>
                                                            </li>
                                            ...
                                            <ul class="pricing">
                                                ...
                                                <li class="add-to-basket"><a href="/basket" title="Proceed to the checkout to send your order...." class="btn_addBasket">Add to basket</a></li>
                                            </ul>
                                        </div>
                                    </li>
                                    <li>
                                        <h3><strong>Part no: 052/01-16x40</strong>Description: M16 x 40 Hex Bolt c/w Nyloc Nut BZP (Vantage Beater Tips, MS90-105 Lids)</h3>
                                        <div class="container">
                                            <a href="http://www.marshall-trailers.co.uk/uploads/spares/large/052-01-16x40.jpg" title="M16 x 40 Hex Bolt c/w Nyloc Nut BZP (Vantage Beater Tips, MS90-105 Lids)" class="fancybox spare-thumbnail">
                                                <img src="http://www.marshall-trailers.co.uk/uploads/spares/052-01-16x40.jpg" alt="M16 x 40 Hex Bolt c/w Nyloc Nut BZP (Vantage Beater Tips, MS90-105 Lids)">
                                            </a>
                                            <div class="info">
                                                <div class="machines">
                                                    <div class="title">Machines:</div>
                                                    ...
                                                    <p class="categories">Component categories: <strong>Bolts, Nuts, Fasteners &amp; Washers &gt; Bolts &amp; Nuts</strong></p>
                                                </div>
                                            </div>
                                            <ul class="pricing">
                                                <li>Unit weight: <strong>10.00kg</strong></li>
