...
;(function($){
	...
	$.fn.bxSlider = function(options){
		 ...
		 */
		// first get the original window dimensions (thanks alot IE)
		...
		var appendControls = function(){
			slider.controls.next = $('<a class="bx-next icon icon-arrow-long-right" href="#"></a>');
			slider.controls.prev = $('<a class="bx-prev icon icon-arrow-long-left" href="#"></a>');
